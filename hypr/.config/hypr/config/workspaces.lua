...
hl.workspace_rule({ workspace = "2", monitor = MONITOR1, default = true, persistent = false })
hl.workspace_rule({ workspace = "3", monitor = MONITOR1, default = true, persistent = false })
